  ...
  return (
    <div className={`relative shrink-0 overflow-hidden bg-[#eee4d6] ${className}`}>
      {resolvedUrl && !failed ? (
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-[radial-gradient(circle_at_top,#f8efe3,#e9ddcc)] px-4 text-center text-[#514C44]">
