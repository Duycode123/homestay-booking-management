...
export default function CustomerProfileClient() {
  ...
  return (
    <CustomerPageShell>
      <div className="relative mb-6 overflow-hidden rounded-[22px] bg-gradient-to-br from-[#234D42] via-secondary to-[#52766B] px-6 py-8 text-white shadow-[0_22px_60px_rgba(11,59,47,0.2)] sm:px-9 sm:py-10">
            ...
            <div className="space-y-7 px-6 py-7 sm:px-8">
              ...
              <div className="flex flex-col gap-4 border-t border-outline-variant pt-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  ...
                  className="inline-flex h-12 items-center justify-center rounded-full bg-secondary px-7 font-display text-sm font-semibold text-white shadow-[0_12px_28px_rgba(11,59,47,0.18)] transition hover:bg-[#52766B] focus:outline-none focus:ring-2 focus:ring-secondary/25 disabled:cursor-not-allowed disabled:opacity-60"
                >
  ...
  return (
    <p
      ...
      className={[
        ...
        isSuccess ? 'border-[#52766B]/25 bg-[#F1F8F2] text-[#52766B]' : 'border-[#C62828]/20 bg-[#FFEBEE] text-[#C62828]',
      ].join(' ')}
    >
      {message.text}
    </p>
