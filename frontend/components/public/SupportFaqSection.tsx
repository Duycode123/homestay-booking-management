      ...
      <section className="mx-auto max-w-6xl px-5 py-14 sm:px-8 sm:py-20">
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1fr)] lg:gap-16">
          <div className="lg:sticky lg:top-28">
            <div className="relative overflow-hidden rounded-[28px] bg-secondary p-6 text-white shadow-[0_22px_60px_rgba(23,58,49,0.18)] sm:p-8">
              <Image
                ...
                alt="Không gian lưu trú tại The Serene Villa"
                fill
              ...
              <div className="relative">
                ...
                <p className="eyebrow mt-7 text-primary-fixed">Trung tâm hỗ trợ</p>
                <h2 className="font-editorial mt-3 max-w-sm text-4xl font-semibold leading-[1.08]">Một câu trả lời rõ ràng cho từng bước lưu trú.</h2>
                <p className="mt-5 max-w-sm text-sm leading-7 text-white/75">
                  Tìm nhanh thông tin cần thiết trước, trong và sau kỳ nghỉ tại The Serene Villa.
                </p>
              </div>
            </div>

            <div className="mt-5 grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
              {quickTopics.map(({ icon: Icon, label, detail }) => (
          ...
          <div>
            ...
            <h2 className="font-editorial mt-3 text-4xl font-semibold leading-[1.1] text-secondary sm:text-5xl">Bạn cần giải đáp điều gì?</h2>
            <p className="mt-4 max-w-xl text-sm leading-7 text-on-surface-variant sm:text-base">
              Các câu hỏi thường gặp được tổng hợp theo hành trình đặt phòng để bạn tìm được câu trả lời nhanh và đúng ngữ cảnh.
            </p>
        ...
        <div className="mx-auto grid max-w-6xl gap-7 px-5 py-10 sm:px-8 sm:py-14 md:grid-cols-[1fr_auto] md:items-center">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <h2 className="font-editorial mt-2 text-3xl font-semibold text-secondary">Gửi yêu cầu, đội ngũ vận hành sẽ tiếp nhận đúng thông tin.</h2>
              <p className="mt-3 max-w-2xl text-sm leading-7 text-on-surface-variant">
                Đăng nhập để gửi sự cố hoặc yêu cầu hỗ trợ gắn với tài khoản và đơn đặt phòng của bạn.
              </p>
            </div>
          </div>
          <div className="flex flex-wrap gap-3 md:justify-end">
            <Link href="/cancellation-policy" className="inline-flex min-h-11 items-center justify-center rounded-full border border-secondary/25 px-5 text-sm font-bold text-secondary transition-colors hover:border-brand-orange hover:text-brand-orange focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-orange/20">Chính sách hủy</Link>
            <Link href="/customer/report-issue" className="inline-flex min-h-11 items-center gap-2 rounded-full bg-secondary px-5 text-sm font-bold text-white shadow-[0_10px_24px_rgba(23,58,49,0.16)] transition duration-200 hover:-translate-y-0.5 hover:bg-secondary-container focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-orange/25">
              Gửi yêu cầu hỗ trợ
