  ...
  return (
    <section className="overflow-hidden rounded-[28px] border border-[#DED7CB] bg-white shadow-[0_18px_50px_rgba(45,42,36,0.08)]">
      <div className="relative min-h-[190px] overflow-hidden bg-gradient-to-br from-[#173F35] via-[#245346] to-[#B28455]">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#142E27]/85 via-[#142E27]/15 to-transparent" />
...
function ClockIcon() { return <svg aria-hidden viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="12" cy="12" r="8" /><path d="M12 8v4l3 2" strokeLinecap="round" /></svg> }
