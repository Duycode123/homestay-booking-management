                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-2 flex items-end justify-between gap-2">
                          ...
                          <button type="button" onClick={() => bookRoom(favorite.roomId)} className="rounded-lg bg-[#17493c] px-3 py-1.5 text-[11px] font-bold text-white transition hover:bg-[#0f392f]">Đặt nhanh</button>
                        </div>
                      </div>
                    </div>
                  </article>
